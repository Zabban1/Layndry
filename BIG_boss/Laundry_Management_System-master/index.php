...
<section class="booking">
   ...
   <form action="index.php" method="post" class="login-form">
      ...
      <div class="btn" onclick="location.href='signup.php';">Sign-up</div>
      <div class="btn" onclick="location.href='forgetpassword.php';">Forgot Password</div>
